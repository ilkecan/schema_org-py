...
class Error(InstantaneousEvent):
    ...
    SCHEMA_PROPERTIES: ClassVar[tuple[PropertyMetadata, ...]] = (
        ...
        PropertyMetadata(name='data', schema_name='data', schema_url='https://schema.org/data', ranges=('Thing',), external_ranges=(), inverse_of=None, superseded_by=None, supersedes=(), equivalent_properties=(), subproperty_of=(), domains=('InstantaneousEvent',), external_domains=(), comment='Data associated with the event, like for instance a log message.', label='data', contributors=(), sources=('https://github.com/schemaorg/schemaorg/issues/4527',)),
        ...
        PropertyMetadata(name='error_code', schema_name='errorCode', schema_url='https://schema.org/errorCode', ranges=('DefinedTerm', 'Integer', 'StatusEnumeration', 'Text'), external_ranges=(), inverse_of=None, superseded_by=None, supersedes=(), equivalent_properties=(), subproperty_of=(), domains=('Error',), external_domains=(), comment='Application or platform dependant error code.', label='errorCode', contributors=(), sources=()),
        ...
        PropertyMetadata(name='source', schema_name='source', schema_url='https://schema.org/source', ranges=('Thing',), external_ranges=(), inverse_of=None, superseded_by=None, supersedes=(), equivalent_properties=(), subproperty_of=(), domains=('InstantaneousEvent',), external_domains=(), comment='The source or cause of the event.', label='source', contributors=(), sources=('https://github.com/schemaorg/schemaorg/issues/4527',)),
        ...
        PropertyMetadata(name='timestamp', schema_name='timestamp', schema_url='https://schema.org/timestamp', ranges=('DateTime',), external_ranges=(), inverse_of=None, superseded_by=None, supersedes=(), equivalent_properties=(), subproperty_of=(), domains=('InstantaneousEvent',), external_domains=(), comment='The instant the event occured.', label='timestamp', contributors=(), sources=('https://github.com/schemaorg/schemaorg/issues/4527',)),
