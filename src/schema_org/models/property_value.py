...
class PropertyValue(StructuredValue):
    ...
    SCHEMA_PROPERTIES: ClassVar[tuple[PropertyMetadata, ...]] = (
        ...
        PropertyMetadata(name='value_group', schema_name='valueGroup', schema_url='https://schema.org/valueGroup', ranges=('Text',), external_ranges=(), inverse_of=None, superseded_by=None, supersedes=(), equivalent_properties=(), subproperty_of=(), domains=('PropertyValue',), external_domains=(), comment='A header or section name for grouping related property values.', label='valueGroup', contributors=(), sources=('https://github.com/schemaorg/schemaorg/issues/4878',)),
    ...
    schema_type: Literal['PropertyValue'] = Field(default='PropertyValue', alias='@type', frozen=True)
    ...
    property_id: Text | URL | list[Text | URL] | None = Field(default=None, alias='propertyID', description='A commonly used identifier for the characteristic represented by the property, e.g. a manufacturer or a standard code for a property. propertyID can be\n(1) a prefixed string, mainly meant to be used with standards for product properties; (2) a site-specific, non-prefixed string (e.g. the primary key of the property or the vendor-specific ID of the property), or (3)\na URL indicating the type of the property, either pointing to an external vocabulary, or a Web resource that describes the property (e.g. a glossary entry).\nStandards bodies should promote a standard prefix for the identifiers of properties from their standards.')
    ...
    value: Boolean | Number | QualitativeValue | BedType | DriveWheelConfigurationValue | SizeSpecification | SteeringPositionValue | StructuredValue | Text | list[Boolean | Number | QualitativeValue | BedType | DriveWheelConfigurationValue | SizeSpecification | SteeringPositionValue | StructuredValue | Text] | None = Field(default=None, alias='value', description="The value of a [[QuantitativeValue]] (including [[Observation]]) or property value node.\\n\\n* For [[QuantitativeValue]] and [[MonetaryAmount]], the recommended type for values is 'Number'.\\n* For [[PropertyValue]], it can be 'Text', 'Number', 'Boolean', 'StructuredValue' or 'QualitativeValue'.\\n* Use values from 0123456789 (Unicode 'DIGIT ZERO' (U+0030) to 'DIGIT NINE' (U+0039)) rather than superficially similar Unicode symbols.\\n* Use '.' (Unicode 'FULL STOP' (U+002E)) rather than ',' to indicate a decimal point. Avoid using these symbols as a readability separator.")
    value_group: Text | list[Text] | None = Field(default=None, alias='valueGroup', description='A header or section name for grouping related property values.')
